        ...
        <section id="apropos" className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div>
                <div
                  className="h-80 rounded-lg shadow-lg bg-cover bg-center bg-landing-hero"
                ></div>
              </div>
            </div>
            ...
            <div className="text-center bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Accédez à votre espace client</h3>
              <p className="text-gray-600 mb-6">
                Connectez-vous pour suivre vos projets, consulter vos devis et accéder à nos services personnalisés.
              </p>
              <Button 
                asChild
